    ...
    <main class="container">
        ...
        <table class="table my-5">
            ...
            <tr>
                ...
                <th scope="col">Physical Adress</th>
            ...
            <tbody>
            <?php
            $statement = $pdo->prepare("SELECT * FROM `leads`");
            ...
            if (isset($_GET['submit-search'])) {
                ...
                if (empty($search)) {
                    ...
                    $search_term = "%" . $search . "%";
                    $stm = $pdo->prepare("SELECT * FROM `leads` WHERE (`name` LIKE ? OR `contact_person` LIKE ? OR `email` LIKE ? OR `address` LIKE ?)");
